...
model = Qwen3VLForConditionalGeneration.from_pretrained(
    "/mnt/ecc5c6c9-7631-4983-9ba0-1ec98729589b/chz/Qwen3/Beauty-LoRA-60", dtype="auto", device_map="auto"
)
processor = AutoProcessor.from_pretrained("/mnt/ecc5c6c9-7631-4983-9ba0-1ec98729589b/chz/Qwen3/Beauty-LoRA-60")
...
if __name__ == "__main__":
    ...
    # 保存结果
    with open("LoRA-results-60-easy.json", "w") as f:
